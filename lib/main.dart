...
import 'package:my_event_app/models/eventmodel.dart'; // Import de EventModel
...
void main() => runApp(
  MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => tycketData()),
      ChangeNotifierProvider(create: (context) => EventModel()), // Ajouter EventModel
      ChangeNotifierProvider(create: (context) => Organisateur()), // Ajouter Organisateur
    ],
    child: MyApp(),
  ),
);
